...
import com.flourish.store.domain.ProductCategory;
import com.flourish.store.service.ProductCategoryService;
...
/**
 * REST controller for managing {@link com.flourish.store.domain.ProductCategory}.
 */
@RestController
@RequestMapping("/api")
